/**
 *  CameraWithCocos3DAppDelegate.m
 *  CameraWithCocos3D
 *
...
#import "CameraWithCocos3DAppDelegate.h"
#import "CameraWithCocos3DLayer.h"
#import "CameraWithCocos3DScene.h"
#import "CC3EAGLView.h"
#import "CameraViewController.h"

@implementation CameraWithCocos3DAppDelegate
...
- (void) applicationDidFinishLaunching:(UIApplication*)application {
    ...
    // 追加
    CC3EAGLView *layer = (CC3EAGLView*)glView.layer;
    layer.opaque = NO;
...
//		CCLOG(@"Retina Display Not supported");
    ...
    [window addSubview:cameraViewController.view];
    
    // make the OpenGLView a child of the view controller
    // [viewController setView:glView]; // viewControllerのviewをglViewにしている（今回はコメントアウト）
    [window addSubview:glView]; // addSubViewでviewControllerのviewの上に載せることにする
	...
	CC3Layer* cc3Layer = [CameraWithCocos3DLayer node];
	[cc3Layer scheduleUpdate];
	
	// Create the customized 3D scene, attach it to the layer, and start it playing.
	cc3Layer.cc3Scene = [CameraWithCocos3DScene scene];
